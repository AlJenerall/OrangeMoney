...
class OrangeMoneyPayment {
    ...
    /**
     * Récupère un token d’accès auprès d’Orange Money en utilisant l’en‑tête Basic
     * déjà encodé (ORANGE_MONEY_AUTH_HEADER).
     *
    ...
    private function getAccessToken() {
        ...
        // Utilise l'en-tête Basic encodé depuis config.php
    ...
    /**
     * Crée un lien de paiement avec Orange Money à partir des informations passées.
     *
